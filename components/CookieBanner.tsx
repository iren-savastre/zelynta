...
function makeStyles(c: ThemeColors, accent: string) {
  return StyleSheet.create({
    ...
    title: { fontSize: 15.5, fontWeight: "800", color: c.text, marginBottom: 3 },
    text: { fontSize: 12.5, lineHeight: 18, color: c.textMuted },
    btnRow: { flexDirection: "row", alignItems: "center", marginTop: 14, gap: 8 },
    spacer: { flex: 1 },
    ...
    ghostTxt: { fontSize: 13.5, fontWeight: "700", color: c.text },
    primaryBtn: {
      paddingVertical: 10,
